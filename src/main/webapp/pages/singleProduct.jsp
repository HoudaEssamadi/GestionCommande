...
<head>
  ...
  <link rel="stylesheet" href="/GestionCmd/css/lightslider.min.css">
  <!-- font awesome CSS -->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></P>
  ...
  <!-- swiper js -->
  <script src="/GestionCmd/js/lightslider.min.js"></script>
  <!-- swiper js -->
  ...
  <script src="/GestionCmd/js/swiper.jquery.js"></script>
  ...
  <script src="/GestionCmd/js/stellar.js"></script>
  <!-- custom js -->
  <script src="/GestionCmd/js/theme.js"></script>
